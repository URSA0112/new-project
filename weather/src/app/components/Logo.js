    ...
    return (
        <div className=" absolute left-[50%] transform -translate-x-1/2  flex justify-center self-center">
            <div className="w-[100px] h-[180px] bg-pink-400 relative justify-self-center self-center" >
                ...
                <div id="logo-circle" className="bg-white w-[110px] h-[110px] rounded-full absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-center items-center gap-3">
